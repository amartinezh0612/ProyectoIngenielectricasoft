            ...
            <div class="card-body">
                <table class="table table-hover table-sm table-bordered" id="tblimplementos">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td nowrap>{{ $imp->nombre_empleado }} {{$imp->apellido_empleado}}</td>
                            <td nowrap>{{ $imp->fecha_entrega }}</td>
                            <td nowrap>
                            @if($imp->estado=="Entregado")
                            <button type="button" class="col-md-6 btn btn-success btn-sm" data-toggle="modal" data-target="#modal-estado-{{$imp->id_implemento}}">Entregado</button>
                            @else
                            <button type="button" class="col-md-6 btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-estado-{{$imp->id_implemento}}">No Entregado</button>
                            @endif
                        </td>
                            <td>
