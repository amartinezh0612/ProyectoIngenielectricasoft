                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select type="text" name="id_cargo" class="form-control" id="validationCustom03"
                                            data-live-search="true">
                                            @foreach($cargos as $car)
                                            <option {{$empleados->id_cargo==$car->id_cargo?'selected':''}}
                                                value="{{$car->id_cargo}}">{{$car->descripcion_cargo}}
                                            </option>
                                            @endforeach
                                        </select>
                                        <div class="invalid-feedback">
